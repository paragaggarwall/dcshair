...
//     const invoiceData = originalData;
...
//     //     setForm({
//     //         proformaInvoice: invoiceData?.proformaInvoice?.proformaInvoiceNo ?? "",
//     //         invoiceNo: invoiceData.invoiceNo ?? "",
//     //         invoiceDate: invoiceData.invoiceDate ? invoiceData.invoiceDate.split("T")[0] : new Date().toISOString().split("T")[0],
//     //         termsOfPayment: invoiceData.termsOfPaymentId ?? "",
//     //         paymentterm: invoiceData.invoicepaymentterm ?? "",
//     //         buyersOrderNo: invoiceData.customerId ?? "",
//     //         lcnumber: invoiceData.lcnumber ?? "",
//     //         lcDate: invoiceData.lcDate ? invoiceData.lcDate.split("T")[0] : "",
//     //         otherRef: invoiceData.otherRefrence ?? "",
...
//     //         airlineNo: invoiceData.operatingAirlines ?? "",
//     //         currency: invoiceData.currency ?? "",
//     //         consigneeid: invoiceData.consigneeId ?? null,
//     //         notifyPartyid: invoiceData.notifyPartyId ?? null,
//     //         contactPersonid: invoiceData.contactPersonId ?? null,
//     //     });

//     //     // Reset dirty tracking when fresh server data arrives
//     //     setDirtyData({});
//     // }, [invoiceData]);

//     // ── Fetch terms of payment when invoice loads ─────────────────────────────
...
//     // ── Field updater — updates local form AND notifies MainInvoice ───────────
...
//                                         ? <PartyCard data={invoiceData.customer} />
//                                         : (
//                                             <div className="flex items-center justify-center h-14 rounded-xl border border-dashed border-slate-200 text-xs text-slate-300 italic">
//                                                 No buyer data
//                                             </div>
...
//                                     <InputBox title="Other Reference(s)" inputFor="otherRef" value={form.otherRef} handleChangeFunction={setField("otherRef")} placeholder="Enter reference" />
//                                 </Grid3>
//                             </Section>
...
//                                     <InputBox title="Airlines / Vessel No." isMandatory inputFor="airlineNo" value={form.airlineNo} handleChangeFunction={setField("airlineNo")} placeholder="Enter Airline / Vessel No." />
//                                     <CustomSelect
//                                         label="Currency"
